...
Docker is set up for this project so the report can run in a
...
This will pull the image from DockerHub, run the container, and create
the report in the `report/` folder.

**Note:** This Makefile works on Windows (Git Bash), Mac, and Linux. The
path formatting handles Windows-specific requirements while remaining
